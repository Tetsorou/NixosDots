          ...
          wayland.windowManager.hyprland = {
            ...
            settings = {
              ...
              layerrule = [
                ...
                # "above_lock 0 , swaync-notification-window"
              ...
              windowrule = [
                ...
                "match:class ^(firefox|Brave-browser|floorp|zen|zen-beta)$, opacity 1.00 1.00"
                ...
                "opacity 1.0 1.0,match:class ^(obsidian)$"
                ...
                "opacity 1.0 1.0,match:class ^(org.gnome.Nautilus|Thunar|thunar|pcmanfm)$"
                "opacity 1.0 1.0,match:class ^(thunar-volman-settings)$"
                "opacity 0.80 0.70,match:class ^(org.gnome.FileRoller)$"
                "opacity 0.80 0.70,match:class ^(io.github.ilya_zlobintsev.LACT)$"
                "opacity 1.0 1.0,match:class ^(Steam|steam|steamwebhelper)$"
                ...
                "opacity 1.0 1.0,match:class ^(VSCodium|codium-url-handler)$"
                "opacity 1.0 1.0,match:class ^(code|code-url-handler)$"
                ...
                "opacity 0.95 0.80,match:class ^(discord)$" # Discord-Electron
                ...
                "pin 1,match:title ^(Picture-in-Picture)$,match:class ^(zen|zen-beta|floorp|firefox)$"

                "float 1,match:class ^(qt5ct)$"
                "float 1,match:class ^(nwg-look)$"
                "float 1,match:class ^(org.kde.ark)$"
                "float 1,match:class ^(Signal)$" # Signal-Gtk
                "float 1,match:class ^(com.github.rafostar.Clapper)$" # Clapper-Gtk
                "float 1,match:class ^(app.drey.Warp)$" # Warp-Gtk
                "float 1,match:class ^(net.davidotek.pupgui2)$" # ProtonUp-Qt
                "float 1,match:class ^(eog)$" # Imageviewer-Gtk
                "float 1,match:class ^(io.gitlab.theevilskeleton.Upscaler)$" # Upscaler-Gtk
                "float 1,match:class ^(yad)$"
